...
git remote add origin https://github.com/whgloveucq/jupyterfiles.git
git remote set-url origin  https://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@github.com/whgloveucq/jupyterfiles.git
